...
<nav class="navbar navbar-dark px-4 py-3">
    <span class="navbar-brand mb-0 h1 fs-3">🐬 海豚量化自適應指揮官儀表板 <small class="fs-6 text-muted-custom">v25.98 資金周轉透視版</small></span>
                ...
                for r_idx, r in enumerate(records):
                    ...
                    html_content += f"""
                                    <tr>
                                        ...
                                        <td>{sell_date_str}</td>
                                        <td class="text-warning">{holding_days_str}</td> <td>{r.get("sell_price", 0)}</td>
...
async def main():
    print("====================================================")
    print("🚀 海豚選股 25.98：[UI總覽透視 × 資金周轉天數版] 啟動...")
    print("====================================================")
